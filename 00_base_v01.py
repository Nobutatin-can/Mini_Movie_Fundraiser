...
# The total profit that this code shows is wrong, it does'nt account for the raffle winner. I don't know how to fix this as the profit is a float, but total_won is a string.
total_profit = "Total Profit: ${:.2f}".format(profit)       # If both total_won and profit were floats, the line would say 'total_profit = "Total Profit: ${:.2f}".format(profit - total_won)'
